...
- `third_party/prism`: Prism.js 1.30.0 components from `https://unpkg.com/prismjs@1.30.0/`.
- `third_party/katex`: KaTeX 0.16.45 runtime files from the npm package.
- `third_party/beautiful-mermaid`: a browser bundle generated from
